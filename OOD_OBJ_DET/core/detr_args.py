...
def get_args_parser():
    ...
    parser.add_argument('--lr_backbone', default=1e-3, type=float) # Self imposed default 1e-3
    ...
    parser.add_argument('--dim_feedforward', default=1024, type=int,
                        help="Intermediate size of the feedforward layers in the transformer blocks") # Manual default 1024
