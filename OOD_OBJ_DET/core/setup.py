...
def setup_config(args, random_seed=None, is_testing=False, ood=False):
	...
	#	print('Forcibly changed operation directory for the mac dev version')
	#	configs_dir = configs_dir.replace('detection', 'OOD_ObjectDet')
	...
	#print(configs_dir.split("configs"))
	file_dir = core.data_dir()
	#file_dir = os.path.join(configs_dir.split("configs")[0], "data") if platform.system() == "Darwin" else core.data_dir()
	#print(file_dir)
